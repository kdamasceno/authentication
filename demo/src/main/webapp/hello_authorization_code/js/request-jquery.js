...
var loginEndpoint = 'https://ariramba.tecgraf.puc-rio.br:8456/webapi/login';
//TODO implementar endpoint no servidor e cadastrar no cliente gluu
var logoutEndpoint = 'https://ariramba.tecgraf.puc-rio.br:8456/webapi/logout';
var demoEndpoint = 'https://ariramba.tecgraf.puc-rio.br:8456/webapi/demo';
...
var REDIRECT = 'https://ariramba.tecgraf.puc-rio.br:8456/hello_authorization_code';
...
function login() {
	...
	var win = window.open(_url, "Login", 'width=800, height=600');
